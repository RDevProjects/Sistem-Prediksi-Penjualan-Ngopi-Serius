            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid items-center grid-cols-2 gap-2 py-10 lg:grid-cols-3">
                    ...
                    <div class="flex flex-col gap-1 lg:gap-2">
                        <span class="text-sm font-medium text-black/70 dark:text-white/70">The current time is</span>
                        <span
                            class="text-2xl font-semibold text-black dark:text-white">{{ now()->format('H:i') }}</span>
                        <span
                            class="text-sm font-medium text-black/70 dark:text-white/70">{{ config('app.timezone') }}</span>
                    </div>
                    @if (Route::has('login'))
